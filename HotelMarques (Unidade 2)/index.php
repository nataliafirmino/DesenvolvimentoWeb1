...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Hotel Marques</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseQuartos" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="quartoAddEdit.php">Adicionar</a>
                                    <a class="nav-link" href="quartoListar.php">Listar</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseCliente" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="clienteAddEdit.php">Adicionar</a>
                                    <a class="nav-link" href="clienteListar.php">Listar</a>
                                </nav>
                            </div>
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseQuarto" aria-expanded="false" aria-controls="collapseQuarto">
                                <div class="sb-nav-link-icon"><i class="fas fa-bed"></i></div>
                                Reservas
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseQuarto" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="reservaAddEdit.php">Adicionar</a>
                                    <a class="nav-link" href="reservaListar.php">Listar</a>
                                </nav>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        ...
                                        Número de Quartos por Reservas
                                    </div>
